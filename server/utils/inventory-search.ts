 ...
 * of inventory search results. The primary artwork (ADR 0025) is the same
 * rule every list uses; its ordering is deterministic, so the small and large
 * URLs always come from the same art variant.
 */
